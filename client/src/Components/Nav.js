...
function Nav() {
    ...
    if(!user) return (
        <nav className="flex flex-wrap justify-between items-center mx-auto bg-gray-200 border-b-2 border-gray-600 px-4 lg:px-10 py-2.5 font-oswald text-lg">
           <Link to="/" className="flex items-center">
            ...
            <div class="flex items-center md:order-2">
                <Link to="/login" className="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-3 text-white uppercase rounded-md w-full hover:text-blue-500">Log in/Register</Link>
            </div>
    ...
    return (
        <div className="float-left px-2 h-screen grid text-gray-700 bg-gradient-to-b from-gray-700 to-gray-900 items-center font-oswald font-bold">
